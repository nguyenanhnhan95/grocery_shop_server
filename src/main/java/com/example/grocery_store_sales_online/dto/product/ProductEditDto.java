...
import static com.example.grocery_store_sales_online.utils.CommonConstants.THIS_COMBOBOX_ITEM_CANNOT_EMPTY;
@Setter
@Getter
...
//        @NotBlank(message = THIS_FIELD_CANNOT_EMPTY_2)
    ...
    private List<@Valid ProductItemEditDto> productItems = new ArrayList<>();
}
