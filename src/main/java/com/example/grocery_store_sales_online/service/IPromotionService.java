...
public interface IPromotionService extends IDeleteModelAble<Long>, IFindAllAble<Promotion>, IFindByIdAble<Promotion,Long>
        ,IGetResultListAble<Promotion>, ISaveModelDtoAble<Promotion, PromotionDto>, IUpdateModelDtoAble<Promotion,Long,PromotionDto>
        ,IFindByCodeAble<Promotion>, IGetListCode<Promotion> {
}
